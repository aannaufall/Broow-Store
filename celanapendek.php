...
<head>
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>Broow Store-Celana Pendek</title> 
	...
	<div id="page-title">
		...
		<div id="page-title-inner">
			...
			<div class="container">
				...
				<h2><i class="ico-stats ico-white"></i>Celana Pendek</h2>
	...
	<div id="wrapper">
        ...
        <!--<div class="title"><h3>Keranjang Anda</h3></div>
            <div class="hero-unit">
      		...
      		<div class="row">
	<?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM produk WHERE jenis='Celana Pendek' order by kode DESC");
		...
		while($data = mysqli_fetch_assoc($sql)){
        		...
        		<div class="span4">
					...
					<!--	<p>
						...
						<div class="clear"><a href="detailproduk.php?hal=detailbarang&kd=<?php echo $data['kode'];?>" class="btn btn-lg btn-danger">Details</a> <a href="detailproduk.php?hal=detailbarang&kd=<?php echo $data['kode'];?>" class="clear"> <a href="index.html" class="btn btn-lg btn-success">Buy &raquo;</a></div>
