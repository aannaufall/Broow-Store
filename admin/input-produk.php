...
if (!empty($_FILES["nama_file"]["tmp_name"]))
{
	...
	{			
		...
		if (move_uploaded_file($_FILES['nama_file']['tmp_name'], $gambar)) {
			$sql="INSERT INTO produk(kode,nama,jenis,size,color,harga,keterangan,stok,gambar) VALUES
            ('$kode','$nama','$jenis','$size','$color','$harga','$keterangan','$stok','$gambar')";
                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="input-produk.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="size" type="text" id="size" class="form-control" autocomplete="off" placeholder="size" autocomplete="off" required />
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="color" type="text" id="color" class="form-control" autocomplete="off" placeholder="color" autocomplete="off" required />
