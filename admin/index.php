...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Halaman Admin Broow Store</title>
            ...
            <aside class="right-side">
                ...
                <section class="content">
                    ...
                    <div class="row">
                        ...
                        <h3 class="panel-title"><i class="fa fa-user"></i> Diagram Penjualan </h3> 
                        </div>
	...
	<script>
		...
		var myChart = new Chart(ctx, {
			...
			data: {
                ...
                //     data: [
				// <?php 
				// $jumlah_teknik = mysqli_query($koneksi,"select * from po_terima where fakultas='kaos'");
				// echo mysqli_num_rows($jumlah_kaos);
				// ?>, 
				// <?php 
				// $jumlah_ekonomi = mysqli_query($koneksi,"select * from po_terima where fakultas='kemeja'");
				// echo mysqli_num_rows($jumlah_ekonomi);
				// ?>, 
				// <?php 
				// $jumlah_fisip = mysqli_query($koneksi,"select * from po_terima where fakultas='boxer'");
				// echo mysqli_num_rows($jumlah_fisip);
				// ?>, 
				// <?php 
				// $jumlah_pertanian = mysqli_query($koneksi,"select * from po_terima where fakultas='celana pendek'");
				// echo mysqli_num_rows($jumlah_pertanian);
				// ?>,
				// <?php 
				// $jumlah_pertanian = mysqli_query($koneksi,"select * from po_terima where fakultas='jaket'");
				// echo mysqli_num_rows($jumlah_pertanian);
				// ?>
				// ],
