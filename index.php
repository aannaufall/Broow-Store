	...
	<div class="slider-wrapper">
		...
		<div id="da-slider" class="da-slider">
			...
			<div class="da-slide">
				...
				<a href="kemeja.php" class="da-link">Lihat Produk</a>
			...
			<div class="da-slide">
				...
				<a href="boxer.php" class="da-link">Lihat Produk</a>
			...
			<div class="da-slide">
				...
				<a href="celanapendek.php" class="da-link">Lihat Produk</a>
			...
			<div class="da-slide">
				...
				<a href="jaket.php" class="da-link">Lihat Produk</a>
	...
	<div id="wrapper">
    	...
    	<div class="container">
			...
			<!-- end: Hero Unit -->
      		...
      		<div class="row">
				  <!-- <div class="col-md-4">
					  <div class="img-responsive" src="" alt=""> -->
