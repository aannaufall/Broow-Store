...
<head>
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>Broow Store-Kemeja</title> 
	...
	<div id="page-title">
		...
		<div id="page-title-inner">
			...
			<div class="container">
				...
				<h2><i class="ico-stats ico-white"></i>Kemeja</h2>
	...
	<div id="wrapper">
        ...
        <!--<div class="title"><h3>Keranjang Anda</h3></div>
            <div class="hero-unit">
      		...
      		<div class="row">
	<?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM produk WHERE jenis='Kemeja' order by kode DESC");
